...
namespace components
{
	...
	public:
		...
		static void debug_lines_init_sync(game::debug_lines_delay_sync_s *sync);
		static bool debug_lines_sync(game::debug_lines_delay_sync_s *sync);
		...
		static void add_and_draw_debug_lines(const int num_lines, const game::debug_line_s* lines, const float* color_float, bool depth_test, int line_width);
